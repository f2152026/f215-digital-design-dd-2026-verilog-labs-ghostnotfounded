...
module tb;
  ...
  initial begin
    ...
    t_i0 = 1'b0; t_i1 = 1'b0; t_s = 1'b1;
    #5;
    
    t_i0 = 1'b0; t_i1 = 1'b1; t_s = 1'b0;
    #5;

    t_i0 = 1'b0; t_i1 = 1'b1; t_s = 1'b1;
    #5;

    t_i0 = 1'b1; t_i1 = 1'b0; t_s = 1'b0;
    #5;

    t_i0 = 1'b1; t_i1 = 1'b0; t_s = 1'b1;
    #5;

    t_i0 = 1'b1; t_i1 = 1'b1; t_s = 1'b0;
    #5;

    t_i0 = 1'b1; t_i1 = 1'b1; t_s = 1'b1;
    #5;
